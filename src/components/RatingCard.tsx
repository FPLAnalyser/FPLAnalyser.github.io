...
const TIER: Record<Tier, TierStyle> = {
  ...
  elite: { bg: 'linear-gradient(165deg,#222326,#121316)', border: 'rgba(231,200,119,.85)', edge: 'linear-gradient(135deg,#fff6d8,#e7c877,#b98f3f)', a: '#ffe9a8', a2: '#ffe08a', as: '#c79a45', glow: '0 0 0 1px rgba(231,200,119,.22), 0 16px 46px rgba(231,200,119,.16)' },
